...
class DocumentEmbedder:
    ...
    async def aadd_document_embedding(self,
        ...
        for item in data:
            ...
            if documents_to_add:
                ...
                logger.info(f"[DOC_EMBEDDER] doc_id={doc_id}, url={url}, doc_source={doc_source}, added {len(documents_to_add)} chunk parts to Chroma, embedding_id_vec={embedding_id_vec}")
                records_to_add.append((doc_id, doc_source, json.dumps(embedding_id_vec), timestamp, timestamp))
